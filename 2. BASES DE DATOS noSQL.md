...
--Se adapta muy bien a JavaScript.
...
```bash
systemctl  status   mongodb   # Estado (nos dice si el sistema está funcionando)
...
```
Conecta directamente con una base de datos que crea.
